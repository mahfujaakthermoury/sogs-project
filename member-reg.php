...
if (isset($_POST['form_submit'])) {
    ...
    $sql = "INSERT INTO member(name, father_name, mother_name) VALUES ('$name', '$father', '$mother')";
    ...
    if ($status) {
        echo   '<div class="container p-4 text-center">
                    <div class="alert alert-success" role="alert">
                       <h5> Registration submited successfully.</h5>
                    </div>
                </div>';
    } else {
        echo   '<div class="container p-4 text-center">
                    <div class="alert alert-success" role="alert">
                       <h5> Registration submited failed.</h5>
                    </div>
                </div>';
    }
...
<section class="reg_section bg-color ">
    <div class="container px-5">
        <h1 class="py-5 ">Member Registration From</h1>
        <hr>
